...
- [complete-example/] Deploy a VPC with a private and public subnet spanned over two availability zones.

<!-- References -->
[complete-example/]: https://github.com/mineiros-io/terraform-aws-vpc/blob/master/examples/complete-example
